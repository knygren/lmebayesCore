...
`Prior_Setup()` and of the Gaussian prior families used throughout **glmbayesCore**. Its purpose is to make
...
This appendix contrasts with applied chapters such as **Chapter&nbsp;03**
(Bayesian linear models with **`rlmb()`**), **Chapter&nbsp;04**
(`Prior_Setup()` workflow), **Chapter&nbsp;07** (GLM foundations), and **Chapter&nbsp;08**
(estimating Bayesian GLMs), where the emphasis is intuitive model building rather than proofs.
Instead, here we focus on **mathematics**:
...
All formulas needed by the main vignettes are derived here from first principles, without relying on other vignettes purely as prerequisites.
