...
For readers who want the full mathematical details of the iid sampler, see **Chapter A07**, which documents
...
2. **Accept–reject envelope sampler (Chapter A07)**
   Chapter A07 develops an accept–reject sampler using a **truncated Gamma prior** for \( \tau \) and a joint envelope over \((\beta,\tau)\).
