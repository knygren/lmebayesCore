...
---
title: "Chapter 3B: Using the Prior_Setup and Prior_Check Functions"
author: "Kjell Nygren"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Chapter 3B: Using the Prior_Setup and Prior_Check Functions}
...
Setup.D93=Prior_Setup(counts ~ outcome + treatment,family=poisson())
```
...
Setup.budworm=Prior_Setup(SF ~ sex*ldose,family=binomial())
```
