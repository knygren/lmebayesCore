...
cat("n=2 max diff:", max_diff, "\n")
cat("v3 chain1 slope:", f3$fixef_draws$slope[1, ], " chain2:", f3$fixef_draws$slope[2, ], "\n")
cat("v4 chain1 slope:", f4$fixef_draws$slope[1, ], " chain2:", f4$fixef_draws$slope[2, ], "\n")
