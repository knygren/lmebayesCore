...
#' sampling -> back-transformation workflow described in \insertCite{Nygren2006}{lmebayesCore}.
#'
#' @details
...
#' using the \code{\link{rglmb}} and \code{\link{rlmb}} functions.
#' 
#' @name glmbfamfunc
#' @aliases
#' glmbfamfunc
...
#'     at the supplied \code{b} (used e.g.\ for multivariate prior--posterior diagnostics in \pkg{glmbayes}).}
#'   }
...
#'   therefore be explicitly added here before they can produce valid DIC or log-likelihood output.
#'
...
#'   during sampling.  However, R-side post-processing (e.g.\ \code{\link{summary.rglmb}})
#'   may still use \code{famfunc\$f1} and \code{famfunc\$f4}, so a registered branch is
#'   still required for those outputs even when the sampler itself has moved to C++.
...
#' 
#' The steps here are based on the procedure described in \insertCite{Nygren2006}{lmebayesCore}.
#'
#' @references
#' \insertAllCited{}
...
#' \insertCite{Nygren2006}{lmebayesCore} and the general implementation outlined in
#' \insertCite{glmbayesSimmethods}{lmebayesCore}. 
#' 
...
#'
#' The envelope sizing logic follows the analysis of \insertCite{Nygren2006}{lmebayesCore}.
#'
#' \describe{
#'
...
#'     (Example 1 in \insertCite{Nygren2006}{lmebayesCore}).
#'   }
#'
#' }
#'
...
#' Vignettes: \insertCite{glmbayesSimmethods,glmbayesChapterA08}{lmebayesCore}.
#'
#' @references
#' \insertAllCited{}
...
#' \insertCite{Nygren2006}{lmebayesCore}, with extensions for GPU acceleration
...
#' follow \insertCite{Nygren2006}{lmebayesCore}. See
#' \insertCite{glmbayesChapterA08}{lmebayesCore} for the full theoretical details (standard form restriction,
...
#' constants, see \insertCite{glmbayesChapterA08}{lmebayesCore}.
#'
...
#' in \insertCite{glmbayesChapterA08}{lmebayesCore}. In the implementation, these theory objects become the
...
#' imply envelope dominance are given in \insertCite{glmbayesChapterA08}{lmebayesCore}. In the implementation, these
...
#' in \insertCite{Nygren2006}{lmebayesCore} for models in standard form (see Section 3--3.3 there). 
...
#'    (\insertCite{Nygren2006}{lmebayesCore}; see also \insertCite{glmbayesChapterA08}{lmebayesCore}), and both subgradients and
...
#'    as in Remark 5 of \insertCite{Nygren2006}{lmebayesCore}.
#'
...
#' \insertCite{Nygren2006}{lmebayesCore}. An expanded narrative is in
...
#' \code{\link{glmb_Standardize_Model}}; \code{\link{rNormal_reg}}, \code{\link{rglmb}}, \code{\link{rlmb}}.
#' Theory and vignettes: \insertCite{Nygren2006}{lmebayesCore};
#' \insertCite{glmbayesChapterA08,glmbayesSimmethods,glmbayesChapterA10,glmbayesChapter12}{lmebayesCore}.
#'
#' @references
#' \insertAllCited{}
...
#' in \insertCite{Nygren2006}{lmebayesCore} and the general implementation outlined
#' in \insertCite{glmbayesSimmethods}{lmebayesCore}.
#'
...
#' \insertCite{glmbayesSimmethods,glmbayesChapterA08,glmbayesChapterA10,glmbayesChapter12}{lmebayesCore}.
#'
#' @references
#' \insertAllCited{}
#' @return
...
#' Theory and narrative: \insertCite{Nygren2006}{lmebayesCore}; vignettes
#' \code{Chapter-A07}, \code{Chapter-A11}; \insertCite{glmbayesChapterA08,glmbayesIndNormGammaVignette}{lmebayesCore}.
...
#'   \code{\link{rglmb}}, \code{\link{glmbfamfunc}}.
#' @references
#' \insertAllCited{}
...
#' \code{\link{EnvelopeDispersionBuild}}; see \insertCite{Nygren2006,glmbayesChapterA08}{lmebayesCore}.
#' @seealso \code{\link{EnvelopeBuild}}, \code{\link{EnvelopeOrchestrator}},
