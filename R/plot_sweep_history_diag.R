...
#' @param ... Passed to methods; see \code{\link{plot_sweep_history_diag.default}}.
#' @return \code{hist} invisibly.
#' @seealso \code{\link{rlmerb}}, \code{\link{rglmerb}},
#'   \code{\link{print.two_block_sweep_history}}
#' @export
plot_sweep_history_diag <- function(hist, ...) {
  UseMethod("plot_sweep_history_diag")
}

#' @rdname plot_sweep_history_diag
#' @method plot_sweep_history_diag default
#' @export
plot_sweep_history_diag.default <- function(
    hist,
    coef_focus,
    what = c("sd", "mean"),
