...
two_block_rNormal_reg_v3 <- function(
  ...
  res <- .two_block_format_v3_cpp_out(
    cpp_out         = cpp_out,
    n               = n,
    re_names        = re_names,
    fixef_start     = fixef_start,
  ...
  structure(
    res,
    class = c("two_block_rNormal_reg_v3", class(res))
  )
}

#' Format raw v3 C++ output into a two_block_rNormal_reg object
#' @noRd
.two_block_format_v3_cpp_out <- function(
    cpp_out,
    n,
    re_names,
    fixef_start,
