...
#'   distributions are utilized \insertCite{LindleySmith1972,DiaconisYlvisaker1979}{lmebayesCore}.
#'   For all other families/link functions, the likelihood subgradient approach of
#'   \insertCite{Nygren2006}{lmebayesCore} is used to generate iid samples.
#'
...
#'   \insertCite{Raiffa1961,LindleySmith1972}{lmebayesCore}.
#'
...
#'   \insertCite{glmbayesIndNormGammaVignette}{lmebayesCore}).
#'
...
#'   subgradients \insertCite{Chen1979,glmbayesGammaVignette}{lmebayesCore}.
#'
#' @references
#' \insertAllCited{}
#' 
#' @author
#' The simulation framework was developed by Kjell Nygren as part of the \pkg{glmbayes} package. It builds on the likelihood subgradient approach described in \insertCite{Nygren2006}{lmebayesCore}, and extends classical Bayesian GLM sampling techniques.
#'
#' @seealso
...
#'
#' Theory and implementation narrative: \insertCite{Nygren2006}{lmebayesCore};
