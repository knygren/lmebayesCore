...
| Document | Contents |
|----------|----------|
| **[R_EXPORTED_AND_DOCUMENTED.md](R_EXPORTED_AND_DOCUMENTED.md)** | `NAMESPACE` exports grouped by **glmbayes** / **lmebayes** overlap, internal `man/` topics, S3 methods, doc topics. |
