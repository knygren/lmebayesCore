# Hierarchical Linear Model Notation
...
The generalized-linear counterpart is
`inst/HIERARCHICAL_GENERALIZED_LINEAR_MODEL_NOTATION.md`, which keeps
stages 2 and 3 verbatim and replaces only the first-stage likelihood.
